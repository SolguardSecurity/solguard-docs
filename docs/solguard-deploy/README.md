...
- finalize y verify de ese futuro root no existen;
...
tests de Deploy. Los workflows se validaron localmente durante la ronda, pero
GitHub Actions remoto no se ejecuto porque no hubo push.
